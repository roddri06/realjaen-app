...
function normEvent(ev) {
  ...
  return {
    ...
    homeTeam: {
      ...
      logo:   `https://realjaen-production.up.railway.app/api/logo/team/${hId}`,
      isJaen: hId === jId,
    },
    awayTeam: {
      id:     aId,
      ...
      logo:   `https://realjaen-production.up.railway.app/api/logo/team/${aId}`,
      isJaen: aId === jId,
    },
...
function normStanding(row) {
  ...
  return {
    ...
    team: {
      ...
      logo:   `https://realjaen-production.up.railway.app/api/logo/team/${row.team?.id}`,
...
function staticUpcoming() {
  ...
  return [
    { id:'14102062', source:'static',
      homeTeam:{ id:202076, name:'Recreativo de Huelva', short:'HUE', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/202076'},
    ...
    { id:'14102134', source:'static',
      ...
      awayTeam:{ id:2838, name:'Xerez CD',   short:'XER', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/2838'},
    ...
    { id:'14102186', source:'static',
      homeTeam:{ id:4490, name:'Atlético Malagueño', short:'ATL', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/4490'},
      awayTeam:{ id:2841, name:'Real Jaén',           short:'JAE', isJaen:true  },
...
function staticResults() {
  ...
  return [
    { id:'14102003', source:'static',
      homeTeam:{ id:2841,  name:'Real Jaén',        short:'JAE', isJaen:true  },
      awayTeam:{ id:43759, name:'Yeclano Deportivo', short:'YEC', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/43759'},
    ...
    { id:'14101949', source:'static',
      homeTeam:{ id:2880, name:'Linares Deportivo', short:'LIN', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/2880'},
      awayTeam:{ id:2841, name:'Real Jaén',          short:'JAE', isJaen:true  },
    ...
    { id:'14101852', source:'static',
      homeTeam:{ id:2841,   name:'Real Jaén',   short:'JAE', isJaen:true  },
      awayTeam:{ id:217210, name:'CDA Águilas', short:'AGU', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/217210'},
    ...
    { id:'14101791', source:'static',
      homeTeam:{ id:24350, name:'UD Melilla', short:'MEL', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/24350'},
      awayTeam:{ id:2841,  name:'Real Jaén',  short:'JAE', isJaen:true  },
    ...
    { id:'14101726', source:'static',
      homeTeam:{ id:2841,   name:'Real Jaén',          short:'JAE', isJaen:true  },
      awayTeam:{ id:189948, name:'Deportiva Minera',   short:'DMI', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/189948'},
    ...
    { id:'15527291', source:'static',
      homeTeam:{ id:229782, name:'Xerez Deportivo FC', short:'XER', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/229782'},
      awayTeam:{ id:2841,   name:'Real Jaén',           short:'JAE', isJaen:true  },
...
function staticStandings() {
  ...
  return [
    { position:1,  team:{ id:217210, name:'CDA Águilas FC',       short:'AGU', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/217210'}, played:27, won:14, draw:7,  lost:6,  goalsFor:35, goalsAgainst:20, goalDiff:15,  points:49 },
    { position:2,  team:{ id:2838,   name:'Xerez CD',              short:'XER', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/2838'}, played:27, won:14, draw:6,  lost:7,  goalsFor:28, goalsAgainst:20, goalDiff:8,   points:48 },
    { position:3,  team:{ id:189948, name:'Deportiva Minera',      short:'DMI', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/189948'}, played:27, won:14, draw:5,  lost:8,  goalsFor:39, goalsAgainst:27, goalDiff:12,  points:47 },
    { position:4,  team:{ id:852868, name:'CD Extremadura',        short:'CEX', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/852868'}, played:27, won:12, draw:10, lost:5,  goalsFor:41, goalsAgainst:31, goalDiff:10,  points:46 },
    { position:5,  team:{ id:55785,  name:'UCAM Murcia',           short:'UCA', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/55785'}, played:27, won:13, draw:7,  lost:7,  goalsFor:39, goalsAgainst:31, goalDiff:8,   points:46 },
    ...
    { position:7,  team:{ id:202076, name:'Recreativo de Huelva',  short:'HUE', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/202076'}, played:27, won:12, draw:9,  lost:6,  goalsFor:34, goalsAgainst:17, goalDiff:17,  points:45 },
    { position:8,  team:{ id:5068,   name:'Lorca Deportiva',       short:'LOR', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/5068'}, played:27, won:12, draw:6,  lost:9,  goalsFor:27, goalsAgainst:26, goalDiff:1,   points:42 },
    { position:9,  team:{ id:55121,  name:'FC La Unión Atlético',  short:'LAU', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/55121'}, played:27, won:10, draw:6,  lost:11, goalsFor:33, goalsAgainst:33, goalDiff:0,   points:36 },
    { position:10, team:{ id:292589, name:'CA Antoniano',          short:'ANT', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/292589'}, played:27, won:10, draw:6,  lost:11, goalsFor:31, goalsAgainst:32, goalDiff:-1,  points:36 },
    { position:11, team:{ id:2880,   name:'Linares Deportivo',     short:'LIN', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/2880'}, played:27, won:8,  draw:12, lost:7,  goalsFor:31, goalsAgainst:37, goalDiff:-6,  points:36 },
    { position:12, team:{ id:43759,  name:'Yeclano Deportivo',     short:'YEC', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/43759'}, played:27, won:10, draw:4,  lost:13, goalsFor:22, goalsAgainst:25, goalDiff:-3,  points:34 },
    { position:13, team:{ id:263797, name:'Salerm Puente Genil',   short:'PUE', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/263797'}, played:27, won:8,  draw:9,  lost:10, goalsFor:23, goalsAgainst:30, goalDiff:-7,  points:33 },
    { position:14, team:{ id:229782, name:'Xerez Deportivo FC',    short:'XDE', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/229782'}, played:27, won:7,  draw:10, lost:10, goalsFor:30, goalsAgainst:33, goalDiff:-3,  points:31 },
    { position:15, team:{ id:324661, name:'CD Estepona',           short:'EST', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/324661'}, played:27, won:8,  draw:5,  lost:14, goalsFor:28, goalsAgainst:37, goalDiff:-9,  points:29 },
    { position:16, team:{ id:24350,  name:'UD Melilla',            short:'MEL', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/24350'}, played:27, won:5,  draw:11, lost:11, goalsFor:25, goalsAgainst:29, goalDiff:-4,  points:26 },
    { position:17, team:{ id:44321,  name:'Almería B',             short:'ALB', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/44321'}, played:27, won:4,  draw:7,  lost:16, goalsFor:20, goalsAgainst:39, goalDiff:-19, points:19 },
    { position:18, team:{ id:4490,   name:'Atlético Malagueño',    short:'ATL', isJaen:false, logo:'https://realjaen-production.up.railway.app/api/logo/team/4490'}, played:27, won:3,  draw:5,  lost:19, goalsFor:22, goalsAgainst:48, goalDiff:-26, points:14 },
  ];
}
...
app.get('/api/squad', async (req, res) => {
  const EXCLUIR = ['Jaime', 'Zeidy Traore', 'Sergio Rivera', 'Fernando Cortijo'];
  try {
